...
for char_id in range(0,5):
    for im_id in range(1,6):
        im = cv2.imread("C://Users//surface//Google Drive//Computer Vision//2559-01//MATLAB//AtoF//"+charlist[char_id]+"//"+str(im_id)+".bmp",0)
...
for im_id in range(1,26):
    im = cv2.imread("C://Users//surface//Google Drive//Computer Vision//2559-01//MATLAB//AtoF//Unknown//" + str(im_id) + ".bmp", 0)
